...
public class MainWindowViewModel : ViewModelBase, IScreen
{
    ...
    public MainWindowViewModel(AuthenticationService authenticationService)
    {
        GoToLoadFromArm = ReactiveCommand.CreateFromObservable(() => Router.Navigate.Execute(new LoadFromArmViewModel(this, authenticationService)));
