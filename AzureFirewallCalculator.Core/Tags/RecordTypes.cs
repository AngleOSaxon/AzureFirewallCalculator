...
public record class ServiceTagProperties(int ChangeNumber, string Region, int RegionId, string Platform, string SystemService, string[] AddressPrefixes, string[] NetworkFeatures);
